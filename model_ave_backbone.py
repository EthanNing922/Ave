...
class AveBackbone(nn.Module):
    def __init__(
            ...
            text_token_embedding_path = None,
            visual_token_embedding_path = None,
        ):
        super(AveBackbone, self).__init__()
        ...
        if text_token_embedding_path is not None:
            textual_tokens = torch.load(text_token_embedding_path, map_location="cpu")
        elif text_tokenizer == "bert":
        ...
        if visual_token_embedding_path is not None:
            visual_tokens = torch.load(visual_token_embedding_path, map_location="cpu")
        elif visual_tokenizer == "beit":
